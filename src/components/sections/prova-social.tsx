...
const testimonials = [
  {
    ...
    initials: "RM",
    text: "Eu tinha 4 abas abertas todo dia só pra saber quanto tinha ganhado. Hotmart numa, Kiwify em outra. Somava na cabeça. Hoje abro o Comizy uma vez e fechei esse problema.",
  ...
  },
  {
    ...
    initials: "BA",
    text: "Peguei um reembolso de R$840 que ia passar batido. Apareceu na hora no dashboard. Só isso já pagou o ano inteiro.",
  ...
  },
  {
    ...
    initials: "DT",
    text: "Coloquei a URL nas plataformas, abri o dashboard e já tava chegando venda. Demorei mais tempo pra tomar café do que pra configurar.",
