...
const whatsappHref =
  "https://wa.me/5513997219515?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Comizy%20e%20gostaria%20de%20saber%20mais.";
    ...
    <footer className="relative bg-[#111] text-white">
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <h4 className="font-semibold text-sm text-white mb-4">Contato</h4>
            <ul className="space-y-3 text-sm text-white/60">
              <li>
                <a
                  ...
                  className="group inline-flex flex-col gap-0.5 hover:text-white transition-colors"
                >
